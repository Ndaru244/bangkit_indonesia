<div class="card im-box">
    ...
    <div class="card-body">
        <h3 class="card-title">CRUD PHP dengan Tema Bela Negara</h3>
        <h5>Selamat datang <b><?= $_SESSION['user_name']; ?></b></h5>
        ...
        <a href="../index.php" class="btn btn-primary">Lihat Halaman Utama</a>
    </div>
</div>